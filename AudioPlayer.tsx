...
import { Play, Pause, SkipBack, SkipForward, Volume2, Music, Scissors, AlertCircle } from 'lucide-react';
...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({ currentTune, onNext, onPrev, onError }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
          ...
          <div className="hidden md:flex items-center gap-3 w-[150px] justify-end">
            ...
            <div className="w-24 h-1 bg-stone-800 rounded-full">
              <div className="w-2/3 h-full bg-stone-500 rounded-full" />
            </div>
          </div>
