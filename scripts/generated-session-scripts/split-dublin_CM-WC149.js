/**
 * Script to split session: dublin_CM-WC149
 * Source: https://www.clarelibrary.ie/eolas/coclare/music/live/dublin_CM-WC149.htm
 */
...
const SOURCE_FILE = String.raw`C:\Users\andre\Documents\tunes\tunes\scripts\archive\MISSING_FILE_dublin_CM-WC149.mp3`;
...
const sessionInfo = {
  location: "Dublin, June",
  musicians: "Paddy Galvin, Quilty, Martin 'Junior' Crehan, Bonavella, Mullagh, fiddles; JP Downes, JC Talty, Michael Falsey, Quilty, flutes; Michael Sexton, Mullagh, accordion; Ita Crehan, Bonavella, Mullagh, piano",
  date: "1969",
  collection: "Carroll-Mackenzie Collection",
  recordingType: "Session",
  sourceUrl: "https://www.clarelibrary.ie/eolas/coclare/music/live/dublin_CM-WC149.htm"
};

const tracks = [
  {
    "id": "dublin_CM-WC149-1",
    "title": "Cliffs of Moher (part of; signature tune)",
    "genre": "Jig",
    start: '.02',
    end: '.18'
  }
...
async function main() {
  console.log('Processing Session: dublin_CM-WC149');
  ...
  const jsonPath = path.join(OUTPUT_DIR, 'dublin_CM-WC149-tunes.json');
