/**
 * Script to split session: willie_clancy_JH31-1
 * Source: https://www.clarelibrary.ie/eolas/coclare/music/live/willie_clancy_JH31-1.htm
 */
...
const SOURCE_FILE = String.raw`C:\Users\andre\Documents\tunes\tunes\scripts\archive\MISSING_FILE_willie_clancy_JH31-1.mp3`;
...
const sessionInfo = {
  ...
  recordingType: "Solo",
  sourceUrl: "https://www.clarelibrary.ie/eolas/coclare/music/live/willie_clancy_JH31-1.htm"
};

const tracks = [
  {
    "id": "willie_clancy_JH31-1-1a",
    "title": "Silver Spear",
    "genre": "Reel",
    start: '.01',
    end: 'TBD'
  ...
  {
    "id": "willie_clancy_JH31-1-2",
    "title": "Lafferty's (volume varies)",
    "genre": "Reel",
    start: '1.19',
    end: '2.25'
  },
  {
    "id": "willie_clancy_JH31-1-3a",
  ...
  {
    "id": "willie_clancy_JH31-1-4",
    "title": "Toss the Feathers (fragment)",
    "genre": "Reel",
    start: '3.48',
    end: '4.10'
  },
  {
    "id": "willie_clancy_JH31-1-5",
    "title": "The Legacy",
    "genre": "Jig",
    start: '4.11',
    end: '5.08'
...
async function main() {
  console.log('Processing Session: willie_clancy_JH31-1');
...
Part of ${sessionInfo.collection}.`,
  ...
  const jsonPath = path.join(OUTPUT_DIR, 'willie_clancy_JH31-1-tunes.json');
