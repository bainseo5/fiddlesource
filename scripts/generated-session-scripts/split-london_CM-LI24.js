/**
 * Script to split session: london_CM-LI24
 * Source: https://www.clarelibrary.ie/eolas/coclare/music/live/london_CM-LI24.htm
 */
...
const SOURCE_FILE = String.raw`C:\Users\andre\Documents\tunes\tunes\scripts\archive\MISSING_FILE_london_CM-LI24.mp3`;
...
const sessionInfo = {
  ...
  recordingType: "Solo",
  sourceUrl: "https://www.clarelibrary.ie/eolas/coclare/music/live/london_CM-LI24.htm"
};

const tracks = [
  {
    "id": "london_CM-LI24-1",
    "title": "Bank of Turf (fragment)",
    "genre": "Hornpipe",
    start: '.02',
    end: '.24'
  }
...
async function main() {
  console.log('Processing Session: london_CM-LI24');
...
Part of ${sessionInfo.collection}.`,
  ...
  const jsonPath = path.join(OUTPUT_DIR, 'london_CM-LI24-tunes.json');
