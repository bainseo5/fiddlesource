/**
 * Script to split session: clounlaheen_T39-1
 * Source: https://www.clarelibrary.ie/eolas/coclare/music/live/clounlaheen_T39-1.htm
 */
...
const SOURCE_FILE = String.raw`C:\Users\andre\Documents\tunes\tunes\scripts\archive\MISSING_FILE_clounlaheen_T39-1.mp3`;
...
const sessionInfo = {
  ...
  recordingType: "Solo",
  sourceUrl: "https://www.clarelibrary.ie/eolas/coclare/music/live/clounlaheen_T39-1.htm"
};

const tracks = [
  {
    "id": "clounlaheen_T39-1-1",
    "title": "Otter's Holt",
    "genre": "Reel",
    start: '.02',
    end: '.45'
...
async function main() {
  console.log('Processing Session: clounlaheen_T39-1');
...
Part of ${sessionInfo.collection}.`,
  ...
  const jsonPath = path.join(OUTPUT_DIR, 'clounlaheen_T39-1-tunes.json');
